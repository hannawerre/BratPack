<template>
  <div class="container">
    ...
    <div class="startbutton-container">
        <button class="button green samll" @click="startGame">Start Game</button>
        <button class="button green samll" @click="unactiveGame">Unactive Game</button>
        <button class="button green samll" @click="updateSettings">Update Info</button>
        <button class="button green samll" @click="logGameData">logGameData</button>
    </div>
